...
- [REST Assured API Automation from scratch + Framework + CI](#rest-assured-api-automation-from-scratch---framework---ci)
  ...
  * [REST Assured](#rest-assured)
    ...
    + [Getting Started](#getting-started)
      ...
      - [Automate GET Request](#automate-get-request)
      - [Hamcrest Assertion on Extracted response](#hamcrest-assertion-on-extracted-response)
      - [What is Hamcrest](#what-is-hamcrest)
        * [Advantages](#advantages)
        * [Hamcrest vs TestNG](#hamcrest-vs-testng)
      - [Hamcrest Collection Matchers](#hamcrest-collection-matchers)
        * [Collection matchers (List, Array, Map, etc.)](#collection-matchers--list--array--map--etc-)
        * [Numbers:](#numbers-)
        * [String:](#string-)
    + [Logging](#logging)
    + [Handling Headers](#handling-headers)
      * [Set Mock Environment for Headers](#set-mock-environment-for-headers)
      * [Multiple Headers in Request - Using Headers](#multiple-headers-in-request---using-headers)
      * [Multiple Headers in Request - Using Map](#multiple-headers-in-request---using-map)
      * [Multi Value Header](#multi-value-header)
    + [Request Specification](#request-specification)
    + [Response Specification](#response-specification)
    + [Automate POST, PUT and DELETE](#automate-post--put-and-delete)
    + [Send Request Payload multiple ways](#send-request-payload-multiple-ways)
    + [Send Complex JSON as Request Payload](#send-complex-json-as-request-payload)
    ...
    + [Complex POJO](#complex-pojo)
      - [creating POJOs](#creating-pojos)
      - [Build Payload and Searlize](#build-payload-and-searlize)
      - [De-serialize and Assert Full Body with JSON Assert](#de-serialize-and-assert-full-body-with-json-assert)
      - [Challenges](#challenges)
      - [Handle Different Data Types in Request and Response](#handle-different-data-types-in-request-and-response)
      - [Assert Field with Different Data Types](#assert-field-with-different-data-types)
      - [Automate One More Test Case](#automate-one-more-test-case)
    + [Coding Challenges](#coding-challenges)
      - [Fetch all nested Keys and values from a given JSON Array](#fetch-all-nested-keys-and-values-from-a-given-json-array)
      - [Fetch values of fields with same key name](#fetch-values-of-fields-with-same-key-name)
    + [Authentication and Authorization](#authentication-and-authorization)
    + [OAuth Flows](#oauth-flows)
    + [Google OAuth2.0](#google-oauth20)
    + [Google OAuth2.0 - Implicit Grant Flow and OpenID Connect](#google-oauth20---implicit-grant-flow-and-openid-connect)
    + [Google OAuth2.0 - Automate](#google-oauth20---automate)
      - [getUserProfile](#getuserprofile)
      - [sendMessage](#sendmessage)
    + [Form Based Authentication](#form-based-authentication)
    + [Handling Cookies](#handling-cookies)
  * [Framework](#framework)
    + [Framework - Spotify OAuth2.0](#framework---spotify-oauth20)
    + [Framework - Automate Tests](#framework---automate-tests)
      - [Automate - Create a Playlist API](#automate---create-a-playlist-api)
      - [Automate - Get a Playlist API](#automate---get-a-playlist-api)
      - [Automate - Update a Playlist API](#automate---update-a-playlist-api)
      - [Automate - Negative Scenarios](#automate---negative-scenarios)
    + [Framework - Create POJOs](#framework---create-pojos)
    + [Framework - Create Reusable methods](#framework---create-reusable-methods)
    + [Framework - Token Manager](#framework---token-manager)
    + [Framework - Routes](#framework---routes)
    + [Framework - Property Loaders](#framework---property-loaders)
    + [Framework - Test Class Refactoring](#framework---test-class-refactoring)
    + [Framework - Lombok](#framework---lombok)
      - [Implement Lombok without Builder](#implement-lombok-without-builder)
      - [Implement Lombok with Builder](#implement-lombok-with-builder)
    + [Framework - Allure Reporting](#framework---allure-reporting)
    + [Framework - Maven Command Line](#framework---maven-command-line)
    + [Framework - Important Optimizations](#framework---important-optimizations)
      - [Use OAuth method to supply token](#use-oauth-method-to-supply-token)
      - [Java Faker API](#java-faker-api)
      - [Java Enum to Store Status Codes](#java-enum-to-store-status-codes)
